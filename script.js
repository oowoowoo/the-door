...
let storage = [],
  ...
  buttonContainer = document.getElementById('buttons');
    ...
    const storyElements = {
        ...
        dontShakeTent: {
            text: 'Albert looked at the tentacle and waved Rosebud off, refusing to shake their hand. If Rosebud had shoulders, they would have dropped at this. Albert muttered a sorry and averted his gaze from their eyes, stepping back.<br><br>“That’s alright. Nice to meet you, Albert.” The green eye spoke sadly.',
            choices: [
                [`Cynthia calls Albert's name`, 'listen']
            ]
        },
        ...
        jump: {
            text: 'Letting out a primal scream, Albert jumped at the guard. Without touching him, the guard dropped to the floor from shock. Albert is surprised, but then smiles.\n\n“Albert, I just got an idea. We need to strip him,” Cynthia began to pick the man up.\n\n“Why?!” Albert recoiled.\n\n“You two have almost the same exact body. If you put on his clothes and hide your hair with his hat, we might not get caught if you say you’re taking care of me. They’ll keep looking for you and we can get Rosebud out of here.”\n\nAlbert thought it over for a moment and tilted his head. He didn’t want to fully show it, but it was a brilliant idea.\n\nSorry, random dude. Albert thought as he stole his clothes.',
            choices: [
        ...
        escort: {
            text: '“Do you remember the way to Rosebud’s cell?” \n\nAlbert nodded and began to walk with Cynthia in that direction. On the way, they were stopped by another guard.\n\n“You got her? Why didn’t you radio any of us?” He questioned Albert, looking to his waist for the object. “You ain’t even got it on you.”\n\n“It… fell off. I couldn’t find it after I detained her.” Albert began to sweat hard, but hoped it didn’t show as bad as it felt.\n\n“Hmm… Alright. Return her ASAP, General doesn’t want either of these chumps snooping around anymore.”\n\nThe guard walked away and Albert exhaled, not knowing that he was holding his breath. They continued walking towards Rosebud.',
            choices: [
        ...
        walk: {
            text: 'During the walk to Rosebud’s cell, the government had sent out a signal to Rosebud’s planet.  When it reaches the planet, the leader of his race is a bit hesitant toward it because he doesn’t know how one of his people is on another planet, let alone Earth.\n\n“Impossible, this must be a joke,” the leader said loudly.\n\n“Maybe one of the ships was attacked and was taken by one of the neighboring solar systems,” a worker said. Upon hearing this, the leader now arranges to take a whole army to the planet to see if it’s true.\n\nWhen they make it to earth the leader says, “We are here because one of our own is being trapped on this disgusting planet, so return him or suffer the consequences.”',
            choices: [
                ['Conitnue walking', 'walk']
            ]
        },
        ...
        walk: {
            text: 'The government doesn’t take this threat lying down and uses the alien war weapons to start an all out war.\n\nCynthia says, “We can’t stop this, there’s too many of them.” \n\nAfter being freed by one of his people, Rosebud tried to stop them from fighting but he died in the crossfire. Now the leader is even more fierce and puts out the weapons they have on Earth.\n\nAfter a week into the war, the aliens have won and earth is in ruins.',
            choices: [
        ...
        walk: {
            text: ' “Yeah, better off they don’t know we’re here,” Cynthia looked down at Rosebud pitifully. “Let’s keep moving.”\n\nAlbert and Cynthia kept moving through the vents until they arrived at a room whose vent covering was already gone. Dropping in, they realized it was a secluded room. Albert quietly celebrated behind Cynthia.',
            choices: [
                ['Look around', 'look']
            ]
        },
        ...
        plan: {
            text: '“So, we can blackmail these workers with their own information. Say we threaten to burn everything in here, do you think they’d buy it?” Cynthia asked.\n\nAlbert rubbed his chin with his hand and replied, “But we have nothing to burn things with?”\n\n“They don’t know that, though, right? We’ve been out and about through their… poorly guarded facility… they don’t know whether or not we’ve been picking up tools.”\n\nAlbert let out an “oh” and nodded hard, “let’s do it then.”\n\nCynthia sighed and looked at the files in her hands and up at Albert. She gave him a tight hug before they stepped out of the room together, files in hand. By chance, the general was walking by at this moment. \n\n“You two! Don’t move!” He shouted at them and grabbed his walkie-talkie to call for backup.',
            choices: [
        ...
        cynthiaSays: {
            text: '“How about you don’t move?! Look at what we have!” Cynthia threw the files at him and pointed to the closet behind them. Albert watched her outburst in shock.\n\n“If you touch those files we’ll-”\n\n“If you don’t let Rosebud return home we’re gonna burn that and everything you love down to the ground!” Cynthia was practically foaming at the mouth with her performance, and the general donned a nervous expression.\n\n“Calm down!” The general put his hands up a bit, afraid of what Cynthia might do. “Alright, we’ll let it leave. Just don’t burn anything!”',
            choices: [
        ...
        blackmail: {
            text: 'The government takes the blackmail and returns Rosebud to them.\n\n“Also we expect no problem once Rosebud is sent home”, Cynthia said. Then they go to the alien landing area to take Rosebud home.\n\n“Well this is it, this is goodbye”, Rosebud said tearfully,\n\n“You help change our live Rosebud, we won’t forget that or you”, Albert said His alien ship comes in and says goodbye to Rosebud, and Albert and Cynthia return to their normal lives.',
            choices: [
        ...
        albertSays: {
            text: 'Albert tries to convince them but with his experience in public speaking he didn’t do so well.\n\nAlbert said nervously, “if you don’t give rosebud we’ll….we’ll…we’ll expose this to the world, these… files”, this doesn’t work and the government takes them to prison.\n\nNow Rosebud remains in prison and is being experimented on, while Albert and Cynthia are just in state prison for 10 years.',
            choices: [
                ['Sad ending', 'restart']
            ]
        },
