...
let storage = [],
  ...
  buttonContainer = document.getElementById('buttons');
    ...
    const storyElements = {
        ...
        workExcited: {
            text: '<br><br><img src="img/peeking.png" alt="peeking"><br><br>During his work, Albert could feel a strange sensation at the nape of his neck. He had hoped to play it off as nerves, or maybe the thrill of new prospects, but this was an all too familiar feeling. The feeling of somebody watching him, boring their eyes into his back',
            choices: [
